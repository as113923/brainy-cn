...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.ru = {
		...
		messages   : {
			...
			'errResizeDegree'      : '无效旋转度。',
			'errResizeRotate'      : '无法旋转图像。',
			'errResizeSize'        : '无效的图像大小。',
			'errResizeNoChange'    : '图像大小没有改变。',
			...
			'cmdchmod'     : '更改权限', // from v2.1 added 20.6.2015
			...
			'ntfdim'      : '图像尺寸获取',
			'ntfchmod'    : '更改权限', // from v2.1 added 20.6.2015
